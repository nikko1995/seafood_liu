        ...
        <div className="flex gap-2 overflow-x-auto pb-4 px-1 scrollbar-hide">
            <button 
               ...
               className={`px-4 py-2 rounded-full text-sm font-bold whitespace-nowrap transition-all ${
                   ...
                   ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30 dark:ring-slate-900' 
                   : 'bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 shadow-sm dark:border dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800'
               }`}
            >
                所有商品
            </button>
